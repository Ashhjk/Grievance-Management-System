...
public class User {
    ...
    @Column(name = "user_name", nullable = false) // Maps to 'user_name' column, ensuring it is not null
    private String userName; // User's name

    @Column(name = "password", nullable = false) // Maps to 'password' column, ensuring it is not null
    private String password; // User's password

    @Column(name = "email", nullable = false) // Maps to 'email' column, ensuring it is not null
