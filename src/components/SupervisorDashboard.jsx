...
const SupervisorDashboard = () => {
    ...
    const [inputComplaintId, setInputComplaintId] = useState(''); 
...
const fetchTechnicians = async () => {
    ...
    const handleAssignAssignee = async (e) => {
        e.preventDefault();
        try {
            const complaintIdToAssign = inputComplaintId || selectedComplaintId; 
            ...
            <ul className="grievance-list">
                {grievances.map((grievance) => (
                    <li key={grievance.complaint_id} className="grievance-item">
                        ...
                        <p>Product: {grievance.complaint} | Status: {grievance.status}</p>
                    </li>
                ))}
            </ul>
